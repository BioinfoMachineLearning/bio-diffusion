...
HM_GPU_JOB_TEMPLATE_FILEPATH = os.path.join(SCRIPT_DIR, "hm_gpu_job_template.yaml")
HM_GPU_JOB_OUTPUT_FILEPATH = os.path.join(SCRIPT_DIR, "hm_gpu_job.yaml")


def main():
    with open(HM_GPU_JOB_TEMPLATE_FILEPATH, "r") as f:
    ...
    with open(HM_GPU_JOB_OUTPUT_FILEPATH, "w") as f:
