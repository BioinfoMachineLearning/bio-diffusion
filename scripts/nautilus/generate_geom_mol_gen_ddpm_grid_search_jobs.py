...
def build_command_string(
    ...
    command_str += f" tags='[bio-diffusion, geom_mol_gen_ddpm, grid_search, nautilus]' logger=wandb logger.wandb.id={run_id} logger.wandb.name='{run_name}_GCPv{run['gcp_version']}"
